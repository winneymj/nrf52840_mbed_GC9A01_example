...
#ifndef __PEBBLE_TYPES_H__
#define __PEBBLE_TYPES_H__

#define GContext lv_obj_t
#define Layer lv_obj_t
#define GColor lv_color_t

#define GColorRichBrilliantLavender LV_COLOR_MAKE(0xFF, 0xAA, 0xFF)
#define GColorVividViolet LV_COLOR_MAKE(0xAA, 0x00, 0xFF)
#define GColorBlueMoon LV_COLOR_MAKE(0x00, 0x55, 0xFF)
