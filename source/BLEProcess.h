...
public:
    ...
    void start()
    {
        serial.printf("Ble process started.\r\n");

        if (_ble_interface.hasInitialized()) {
            serial.printf("Error: the ble instance has already been initialized.\r\n");
            return;
        }
    ...
    void stop()
    {
        if (_ble_interface.hasInitialized()) {
            ...
            serial.printf("Ble process stopped.");
        }
    }
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *event)
    {
        ...
        serial.printf("Ble instance initialized\r\n");
    ...
    void start_advertising()
    {
        ...
        if (error) {
            serial.printf("_ble.gap().setAdvertisingParameters() failed\r\n");
            return;
        }
